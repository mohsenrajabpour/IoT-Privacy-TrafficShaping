#ifndef CLICK_BUFFERTIME_HH
#define CLICK_BUFFERTIME_HH
...
class BufferTime : public Element { public:

    BufferTime() CLICK_COLD;

    const char *class_name() const              { return "BufferTime"; }
